...
- (instancetype)initWithTitle:(NSString *)title body:(NSString *)body image:(UIImage *)image buttonText:(NSString *)buttonText action:(dispatch_block_t)action {
    ...
    self.topPadding = kDefaultTopPadding*screenHeight/667;
    self.underIconPadding = kDefaultUnderIconPadding*screenHeight/667;
    self.underTitlePadding = kDefaultUnderTitlePadding*screenHeight/667;
    self.bottomPadding = kDefaultBottomPadding*screenHeight/667;
...
//    _mainTextLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(_imageView.frame) + self.underIconPadding, contentWidth, 0)];
    _mainTextLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 30*screenHeight/667 + self.underIconPadding, contentWidth, 0)];
